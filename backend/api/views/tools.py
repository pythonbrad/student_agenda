...
class MegaFile:
    ...
    """
    def __init__(self, auth={}, cloud_folder=None, tmp_folder=None):
        self.mega_api = Mega()
    ...
    def write(self, data):
        if cloud_folder != None and auth != None:
            ...
            raise ValueError("auth and cloud_folder is required for this operation")
